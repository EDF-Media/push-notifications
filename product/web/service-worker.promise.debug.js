...
self.addEventListener('push', function (event) {
    event.waitUntil(new Promise(function(fullfill, reject) {
        ...
        var checkAndTryNotification = function(e) {
            ...
            var getNotificationDetails = function() {
                ...
                if (!iDBSupported) {
                    checkTimeout = IS_DEV ? DEV_TIMEOUT : parseInt(Math.random() * MAX_TIMEOUT);
                    ...
                    idbKeyval.get('checkTimeout').then(function(value) {
                        ...
                        if (value) {
                            checkTimeout = IS_DEV ? DEV_TIMEOUT : value;
                        } else {
                            checkTimeout = IS_DEV ? DEV_TIMEOUT : parseInt(Math.random() * MAX_TIMEOUT);
                        }
